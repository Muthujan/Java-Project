...
class bookreturn implements ActionListener
{
	...
	bookreturn()
	{
		...
		b.setBounds(450,550,80,30);
		b1.setBounds(540,550,80,30);
		b2.setBounds(630,550,80,30);
		b3.setBounds(720,550,80,30);
		p.add(l);
		p.add(l1);
		p.add(t1);
		p.add(l2);
	...
	public void actionPerformed(ActionEvent a)
	{
		try
		{
			...
			if(r!=0)
			{
				JOptionPane.showMessageDialog(f,new String("Return"));
			}
			t1.setText("");
			t2.setText("");
			t3.setText("");
